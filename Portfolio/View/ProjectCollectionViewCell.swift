...
class ProjectCollectionViewCell: UICollectionViewCell {
    ...
    func setupConstraints() {
        ...
        self.addConstraint(NSLayoutConstraint(item: viewBody, attribute: .left, relatedBy: .equal, toItem: self, attribute: .left, multiplier: 1, constant: 0))//16
        //Right
        ...
        self.addConstraint(NSLayoutConstraint(item: viewBody, attribute: .right, relatedBy: .equal, toItem: self, attribute: .right, multiplier: 1, constant: 0))//-16
